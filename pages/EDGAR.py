...
tab1, tab2 = st.tabs(["📋 SEC EDGAR FILINGS", "👥 INSIDER TRADING"])
...
with tab2:
    st.markdown("### 👥 INSIDER TRADING (OpenInsider)")
    
    st.markdown("""
    <div style="background-color: #111; border-left: 3px solid #FFAA00; padding: 15px; margin: 10px 0;">
        <p style="font-size: 11px; color: #FFAA00; font-weight: bold;">📊 OPENINSIDER INTEGRATION</p>
        <p style="font-size: 10px; color: #999; margin-top: 5px;">
            Track insider transactions from executives, directors, and major shareholders.
        </p>
    </div>
    """, unsafe_allow_html=True)
    ...
    with col2:
        search_insider_btn = st.button("🔍 SEARCH INSIDER", use_container_width=True)
